...
~function(){
	...
	if(document.getElementById('signClose')){
	 ...
	 signScroll()
function signScroll(){
	if( document.getElementById('scrollPc') &&document.getElementById('scroll_contentPc')){
		var scrollPc = document.getElementById('scrollPc');
		var scroll_contentPc = document.getElementById('scroll_contentPc');
		var objscroll=new Scrollbar('scrollPc','scroll_contentPc',720,300);
	  objscroll.Yscrollbar('images/ScrollBar.jpg',16,14,'images/ScrollHandle.jpg',36);//开启Y轴纵向滚动条
...
fnSignPop()
	function fnSignPop(){
		...
		if(document.querySelector('#closeResultGold')){
			...
			closeResultGold.onclick = function(){
				 popLayerSign.style.display = 'none';
