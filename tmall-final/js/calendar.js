...
/*
            ...
            function calendar(showMonth,showDate,sName ) {
                    ...
                    for ( var i=0; i<rows; i++ ) {
                        ...
                        for ( var j=0; j<cells; j++ ) {
                            ...
                            if ( v > 0 && v <= showMonthDays  ) {
                                ...
                                }else  if ( today.getFullYear() == showYear &&  showMonth &&  v ==showDate) {
